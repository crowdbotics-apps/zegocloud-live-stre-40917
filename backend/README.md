...
## Project Structure
    ...
    ├── zegocloud_live_stre_40917  # Django project configurations
...
1. Clone this repo and `cd zegocloud_live_stre_40917`
...
2. Clone this repo and `cd zegocloud_live_stre_40917`
